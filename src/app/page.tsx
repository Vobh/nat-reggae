    ...
    <>
          ...
          <div className="relative mx-auto text-center flex flex-col items-center gap-10">
            <div>
              <Heading>
                ...
                bg-clip-text">Delivery no seu Discord</span>
              </Heading>
            </div>
            ...
            <ul className="space-y-2 text-base/7 text-gray-600 text-left flex flex-col
             items-start">
              {["Alertas em tempo real para eventos críticos", 
                "Totalmente free, e pra sempre", 
                "Compre ingressos pros seus shows favoritos",
                ].map((item, index) => (
            ...
            <div className="w-full max-w-80">
              <ShinyButton href="/shows" className="relative z-10 h-14 w-full text-base shadow-lg transition-shadow duration-300 hover:shadow-xl">Start for free today</ShinyButton>
            </div>
          </div>
        </MaxWidthWrapper>
      </section>
          ...
          <MaxWidthWrapper className="relative">
            ...
            ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4">
              <MockDiscordUI>
                <AnimatedList>
                  <DiscordMessage 
                    avatarSrc="/natureggae.jpg"
                    avatarAlt="Natureggae Avatar" 
                    username="NatuReggae" 
                  ...
                  <DiscordMessage 
                    ...
                    content={{
                      amount: "$49.00",
                      email: "loveirinalove@hambler.case",
                      plan: "PRO",
                    }}
                  />
        ...
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-20">
          <div>
            <h2 className="text-center text-base/7 font-semibold text-brand-600">
                Monitoramento Intuitivo
            </h2>
            <Heading>Esteja um passo a frente com Insights em tempo real</Heading>
          </div>
            ...
            <div className="relative max-lg:row-start-1">
              ...
              max-lg:rounded-t-[calc(2rem+1px)]">
                <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                  ...
                  <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                    From new users signups to successful Payments, PingPanda notifys
              ...
              <div className="pointer-events-none absolute inset-px rounded-lg shadow ring-1 ring-black/5 max-lg:rouded-t-[2rem]" />
            </div>
              {/* Third bento grid element */}
            <div className="relative max-lg:row-3 lg:col-start-2 lg:row-start-2">
            ...
            <div className="relative lg:row-span-2">
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
                <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
                  ...
                  <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                    Connect PingPanda with your existing workflow in munutes and 
                    call our intuitive logging API from any language.
                  </p>
                </div>

                <div className="relative min-h-[30rem] w-full grow">
                    <div className="absolute bottom-0 left-10 right-0 top-10 overflow-hidden
                    rounded-tl-xl bg-gray-900 shadow-2xl">
                      <div className="flex bg-gray-800/40 ring-1 ring-white/5">
                        <div className="-mb-px flex text-sm/6 font-medium text-gray-400">
                          <div className="border-b border-r border-b-white/20 border-r-white/10
                          bg-white/5 px-4 py-2 text-white">
                            pingpanda.js
                          </div>
                        </div>
                      </div>           
      ...
      <section className="relative py-24 sm:py-32 bg-white">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-20">
          ...
          <Heading className="text-center">O que os nossos clientes estão dizendo</Heading>
          </div>
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-gray-200">
            ...
            <div className="flex flex-auto flex-col gap-4 bg-brand-25 p-6 sm:p-8 lg:p-16 rounded-t-[2rem] lg:rounded-tr-none lg:rounded-l-[2rem]">
              ...
              <p className="text-base sm:text-lg lg:text-lg/8 font-medium tracking-tight text-brand-950 text-center lg:text-left text-pretty">
                          NatuReggae has been a game-changer for me. I'been using it for two
            ...
            <div className="flex flex-auto flex-col gap-4 bg-brand-25 p-6 sm:p-8 lg:p-16 rounded-b-[2rem] lg:rounded-bl-none lg:rounded-r-[2rem]">
              ...
              <p className="text-base sm:text-lg lg:text-lg/8 font-medium tracking-tight text-brand-950 text-center lg:text-left text-pretty">
                  NatuReggae's been paying off for our SaaS. Nice to have a simple way to 
          ...
          <ShinyButton href="/shows" className="relative z-10 h-14 w-full max-w-xs text-base shadow-lg transition-shadow duration-300 hover:shadow-xl">
