                    ...
                    return (                
                        <div className="p-5 grid grid-cols-1 md:grid-cols-4 gap-4 shadow-md border border-gray-300 rounded-xl">
                            ...
                            <div className="col-span-1 md:col-span-3">
                                <h2 className="mb-4 text-xl">{reservation.product.title}</h2>
                                ...
                                <Link
                                    ...
                                    className="mt-6 cursor-pointer inline-block py-4 px-6 bg-natureggae hover:bg-natureggae-dark transition text-white rounded-xl"
                                >
                                    Go to product
                                </Link>
                            </div>
