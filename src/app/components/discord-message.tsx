...
const getBadgeStyles = (color: BadgeColor) => {
    switch (color) {
        ...
        case "#faa61a":
            return "bg-yellow-500/10 text-yellow-400 ring-green-500/20"
        default:
            return "bg-gray-500/10 text-gray-400 ring-green-500/20"
    }
}
    ...
    return (
        <div className="w-full flex items-start justify-start">
            <div className="flex items-center mb-2">
                <Image src={avatarSrc} alt={avatarAlt} width={40} height={40}
            ...
            <div className="w-full max-w-xl">
                <div className="flex items-center">
                    ...
                    <span className="ml-2 px-1.5 py-0.5 text-xs font-semibold
                ...
                <div className="bg-[#2f3136] text-sm w-full rounded p-3
                mb-4 mt-1.5">
